...
export default function InvitationGather() {
  ...
  return (
    <div>
      <div className="w-[330px] h-[317px] relative shadow rounded-2xl mb-[1px] py-[15px]">
        <div className="h-[273px] flex-col justify-start items-center gap-2.5 flex">
          ...
          <div className="self-stretch h-[53px] flex-col justify-start items-start gap-0.5 flex px-[20px]">
            <div className="self-stretch text-neutral-950 text-2xl font-semibold font-['Pretendard'] leading-[31.20px]">
              christmas party
            </div>
            <div className="text-[#686868] text-[13px] font-medium font-['Pretendard'] leading-tight">
      ...
      <div className="w-[330px] flex justify-center items-center relative">
        <svg
      ...
      <div className="h-[143px] w-[330px] flex-col justify-start items-start gap-7 flex shadow rounded-2xl mt-[-10px]">
        <div className="self-stretch h-11 pl-1 flex-col justify-center items-start gap-1 flex">
          <div className="self-stretch justify-start items-center gap-2 inline-flex">
            <div className="w-3.5 h-3.5 relative" />
            <div className="justify-start items-center gap-2 flex">
              <div className="text-neutral-950 text-[13px] font-medium font-['Pretendard'] leading-tight">
                2024.12.24 오후 6시
              </div>
            </div>
          </div>
        ...
        <div className="self-stretch px-1 justify-between items-center inline-flex">
          <div className="justify-start items-center flex">
            <div className="w-[34px] h-[34px] justify-center items-center flex">
              <img
                className="w-[34px] h-[34px] rounded-full border border-white"
          ...
          <div className="justify-start items-center gap-1 flex">
            <div className="text-[#aeaeae] text-sm font-semibold font-['Pretendard'] leading-[18.20px]">
              from
            </div>
            <div className="text-neutral-950 text-sm font-medium font-['Pretendard'] leading-tight">
              maybin_
            </div>
          </div>
        </div>

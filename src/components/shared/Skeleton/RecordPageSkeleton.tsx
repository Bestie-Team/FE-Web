  ...
  return (
    <div className="h-dvh bg-base-white w-full extended-container">
      ...
      <Flex direction="column" className="pt-5 px-6 gap-4 text-T2">
        ...
        <span className="bg-grayscale-50 w-[188px] h-[26px] rounded-[4px] animate-pulse" />
      </Flex>
      <Spacing size={36} />
      <Flex direction="column" className="px-6 gap-5">
        <Flex className="bg-grayscale-50 rounded-2xl px-4 py-5 gap-3 animate-pulse">
          ...
          <Flex direction="column" className="gap-[6px]">
            <span className="bg-grayscale-50 w-[51px] h-[18px] animate-pulse" />
            <span className="bg-grayscale-50 w-[200px] h-[14px] animate-pulse" />
          </Flex>
        </Flex>
      </Flex>
    </div>

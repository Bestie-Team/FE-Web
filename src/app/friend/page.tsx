...
export default function Friend() {
  ...
  return (
    <div className="pt-[97px] mx-auto h-screen pl-5 bg-[#f4f4f4]">
      ...
      <div className="h-16 px-4 py-3.5 bg-base-white rounded-[20px] justify-between items-center inline-flex w-full max-w-[350px] mt-[12px] mb-[16px]">
        ...
        <div className="px-3 py-2 rounded-lg border border-[#e8e8e8] justify-center items-center gap-2 flex cursor-pointer">
      ...
      <FixedBottomButton label="선택 완료" onClick={() => {}} />
    </div>
  );
}
